...
class create_synthetic_data:
	def __init__(self, num_node = 0 , frac_sparse = 0 , num_msg = 0 , num_sentiment_val = 0 , start_time = 0 , end_time = 0 ):
...
def main():
	...
	num_node = 10
	frac_sparse = .4
	flag_generate_msg = False

	if flag_generate_msg==True:
		num_msg = 40
		num_sentiment_val = 5
		start_time = 0
		end_time = 40
